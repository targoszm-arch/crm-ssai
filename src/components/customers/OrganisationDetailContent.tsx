...
/**
 * Shared body for the company drawer and the full /companies/:id page.
 */
    ...
    <>
      <div className="space-y-4">
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-semibold text-lg shrink-0">
            {company.company_name?.substring(0, 2).toUpperCase()}
          </div>
          <div className="flex-1 min-w-0">
            <h2 className="text-xl font-semibold truncate">{company.company_name}</h2>
