...
interface OrganisationsBulkActionBarProps {
    ...
    <Card className="border-primary bg-primary/5">
      <CardContent className="p-4 flex items-center justify-between">
        <span className="text-sm font-medium">
          {selectedCount} organisation{selectedCount !== 1 ? "s" : ""} selected
        </span>
        <div className="flex gap-2">
          ...
          <AddToListMenu companyIds={selectedIds} />
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Delete {selectedCount} organisation{selectedCount !== 1 ? "s" : ""}?</AlertDialogTitle>
                <AlertDialogDescription>
                  This action cannot be undone. This will permanently delete the selected 
                  organisations and may affect associated contacts and deals.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
