...
export function EmailTemplateEditor({ value, onChange, className }: EmailTemplateEditorProps) {
  ...
  const [ctaStyle, setCtaStyle] = useState<string>("primary");
        ...
        <div className="flex items-center justify-between border-b pb-2 mb-2">
          ...
          {mode === "visual" && (
            <div className="flex items-center gap-1">
              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("bold")} title="Bold">
                <Bold className="h-3.5 w-3.5" />
              </Button>
              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("italic")} title="Italic">
                <Italic className="h-3.5 w-3.5" />
              </Button>
              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("underline")} title="Underline">
                <Underline className="h-3.5 w-3.5" />
              </Button>

              <div className="w-px h-5 bg-border mx-1" />

              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("h1")} title="Heading 1">
                <Heading1 className="h-3.5 w-3.5" />
              </Button>
              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("h2")} title="Heading 2">
                <Heading2 className="h-3.5 w-3.5" />
              </Button>

              <div className="w-px h-5 bg-border mx-1" />

              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("ul")} title="Bullet List">
                <List className="h-3.5 w-3.5" />
              </Button>
              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleFormat("ol")} title="Numbered List">
                <ListOrdered className="h-3.5 w-3.5" />
              </Button>

              <div className="w-px h-5 bg-border mx-1" />

              <Button type="button" variant="ghost" size="icon" className="h-7 w-7" onClick={handleLinkButtonClick} title="Insert Link (select text first to wrap)">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="template-link-url" placeholder="https://example.com" value={linkUrl} onChange={(e) => setLinkUrl(e.target.value)} />
            </div>
            {!hasTextSelection && (
              <div className="space-y-2">
                <Label htmlFor="template-link-text">Link Text</Label>
                <Input id="template-link-text" placeholder="Click here" value={linkText} onChange={(e) => setLinkText(e.target.value)} />
              </div>
            )}
            <div className="flex items-center space-x-2">
              <Checkbox id="track-link-template" checked={trackLinkClicks} onCheckedChange={(c) => setTrackLinkClicks(!!c)} />
              <Label htmlFor="track-link-template" className="text-sm">Track clicks</Label>
            </div>
          </div>
          <DialogFooter>
      ...
      <Dialog open={imageLinkDialogOpen} onOpenChange={setImageLinkDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="track-image-template" checked={trackImageClicks} onCheckedChange={(c) => setTrackImageClicks(!!c)} />
              <Label htmlFor="track-image-template" className="text-sm">Track clicks</Label>
            </div>
          </div>
      ...
      <Dialog open={ctaDialogOpen} onOpenChange={setCtaDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label>Style</Label>
              <Select value={ctaStyle} onValueChange={(v) => setCtaStyle(v)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="track-cta-template" checked={trackCtaClicks} onCheckedChange={(c) => setTrackCtaClicks(!!c)} />
              <Label htmlFor="track-cta-template" className="text-sm">Track clicks</Label>
            </div>
          </div>
          <DialogFooter>
