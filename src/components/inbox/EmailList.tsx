  ...
  return <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto">
        {isLoading ? <div className="p-4 space-y-3">
          ...
          {filteredEmails.map(email => <div key={email.id} className={cn("p-4 hover:bg-accent transition-colors cursor-pointer relative group", selectedEmail?.id === email.id && "bg-accent", !email.is_read && "bg-primary/5 border-l-2 border-l-primary")} onClick={() => onSelectEmail(email)}>
